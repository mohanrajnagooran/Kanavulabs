...
const Hero = () => {
  return (
    <section className="pt-10 pb-20 px-6 text-center bg-white">
      <h1 className="text-4xl md:text-5xl max-w-3xl font-bold mb-6  mx-auto">Accelerate Your Digital Growth with  <span className='text-orange-500'>Kanavu Labs.</span> </h1>
